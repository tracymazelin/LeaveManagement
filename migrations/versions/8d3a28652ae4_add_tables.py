...
Revision ID: 8d3a28652ae4
Revises: 
Create Date: 2022-04-04 16:45:00.550599
...
def upgrade():
    ...
    op.create_index(op.f('ix_manager_created_date'), 'manager', ['created_date'], unique=False)
    ...
    sa.ForeignKeyConstraint(['employee_id'], ['employee.employee_id'], ),
    sa.ForeignKeyConstraint(['manager_id'], ['manager.manager_id'], ),
    sa.PrimaryKeyConstraint('manager_employee_id')
    )
...
def downgrade():
    ...
    op.drop_index(op.f('ix_manager_created_date'), table_name='manager')
