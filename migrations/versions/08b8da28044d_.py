...
Revision ID: 08b8da28044d
Revises: b805afb2d493
Create Date: 2022-04-26 13:30:38.294712
...
revision = '08b8da28044d'
down_revision = 'b805afb2d493'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('updated_date', sa.DateTime(), nullable=True),
    sa.Column('deleted_date', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['employee_id'], ['manager.employee_id'], ),
