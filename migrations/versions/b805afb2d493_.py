...
Revision ID: b805afb2d493
Revises: 502c29130090
Create Date: 2022-04-26 13:26:51.200617
...
revision = 'b805afb2d493'
down_revision = '502c29130090'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('manager_id', sa.Integer(), nullable=True, use_alter=True),
